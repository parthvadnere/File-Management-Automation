"""
Django settings for pharmpix_django project.
...
SECRET_KEY = 'django-insecure-i4^o1n_90ff0s(6m+9_5rmc(h%!s2gu+m_y$jq0cpxm8^ewurv'
...
ROOT_URLCONF = 'pharmpix_django.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'client_manager/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pharmpix_django.wsgi.application'
...
STATIC_URL = '/static/'
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'client_manager', 'static')]
